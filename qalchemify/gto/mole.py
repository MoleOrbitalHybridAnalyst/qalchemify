    ...
    def generator(l):
        ...
        def get_vorb(mol):
            ...
            for i in mchangeA + mdualA:
                p0, p1 = aoslices[i][-2:]
                np.fill_diagonal(vorb[p0:p1,p0:p1], vorb_molA(l))
            for i in mchangeB + mdualB:
                p0, p1 = aoslices[i][-2:]
                np.fill_diagonal(vorb[p0:p1,p0:p1], vorb_molB(l))
            return vorb
